const CONFIG = {
    ...
    btnReply: 'Gửi cho anh đi <3',
    reply: 'Bởi vì anh thật đẹp trai, chuẩn gu emm <33',
    mess: 'Ỏww..🥰 Mời em đến với thế giới của anh.. Sao hai ta không thử tìm hiểu nhau 😘😘',
    messDesc: 'Thử like 1 bài viết của mình và mình sẽ ib cho bạn.. ❤',
    btnAccept: 'Okiiiii lun <3',
    messLink: 'https://www.facebook.com/iamlong.limited/' //link mess của các bạn. VD: https://m.me/nam.nodemy
}
